        ...
        $event->addButton(
            [
                'attr' => [
                    ...
                    'href'        => $this->router->generate('mautic_company_batch_companytag_view'),
                    'data-header' => $this->translator->trans('mautic.company_tags.action.change'),
                ],
                'btnText'   => $this->translator->trans('mautic.company_tags.action.change'),
