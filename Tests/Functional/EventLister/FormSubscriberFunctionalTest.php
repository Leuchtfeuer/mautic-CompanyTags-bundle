...
class FormSubscriberFunctionalTest extends MauticMysqlTestCase
{
    ...
    {
        // Use ReloadFacade instead of HTTP request to avoid auth issues
        $pluginReloader = self::getContainer()->get(\Mautic\PluginBundle\Facade\ReloadFacade::class);
        \assert($pluginReloader instanceof \Mautic\PluginBundle\Facade\ReloadFacade);
        $pluginReloader->reloadPlugins();
